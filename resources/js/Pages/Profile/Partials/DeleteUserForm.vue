    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Una vez que se haya eliminado su cuenta, todos sus recursos y datos se eliminarán permanentemente. Antes de
                eliminar su cuenta, descargue los datos o información que desee conservar.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Una vez que se haya eliminado su cuenta, todos sus recursos y datos se eliminarán permanentemente.
